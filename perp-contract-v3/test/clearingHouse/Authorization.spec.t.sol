...
import { ClearingHouseSpecSetup } from "./ClearingHouseSpecSetup.sol";

contract ClearingHouseAuthorizationSpec is ClearingHouseSpecSetup {
    ...
    function test_setAuthorization() public {
        ...
        clearingHouse.setAuthorization(mockedOrderGateway, true);
        clearingHouse.setAuthorization(mockedOrderGatewayV2, true);
        vm.stopPrank();

        assertEq(clearingHouse.isAuthorized(trader, mockedOrderGateway), true);
        assertEq(clearingHouse.isAuthorized(trader, mockedOrderGatewayV2), true);
    }
    ...
    function test_setAuthorization_RevertIf_NotWhitelistedAuthorization() public {
        ...
        clearingHouse.setAuthorization(trader2, true);
    }
}
